...
def create_betting_table():
    ...
    for i in range(len(gameslist)):
        ...
        print("""\
                ...
                <td><input type="text" name="score1_""" + str(i) + """" value="" maxlength="1" size="1"/>-<input type="text" name="score2_""" + str(i) + """" value="" maxlength="1" size="1"/></td>
...
if __name__ == '__main__':
    _functions = {'create_ranking_table': create_ranking_table, 'create_detailed_table': create_detailed_table, 'create_betting_table': create_betting_table}
